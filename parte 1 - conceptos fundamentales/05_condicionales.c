/*
 * 05_condicionales.c - Parte 1, Lección 5: Sentencias condicionales
 *
 * Esta lección presenta las sentencias condicionales, que permiten que un
 * programa tome decisiones y ejecute distintos bloques de código según
 ...
 * =============================================================================
 *
 * Nuestros programas hasta ahora han sido lineales: ejecutan cada línea de
 * código de arriba abajo, siempre en el mismo orden. Para crear programas
 * inteligentes, debemos permitir que puedan tomar decisiones.
 *
...
int main(void)
{
	...
	/*
	 * La cláusula `else` ofrece un bloque alternativo cuando la condición
	 * del `if` es falsa.
	 *
	 * Sintaxis:
	 * if (condición) {
	 ...
	 * sentencias `else if`. El programa evalúa cada condición en orden y
	 * ejecuta la primera que sea verdadera. El `else` final es opcional y
	 * actúa como un caso por defecto.
	 */
	int user_grade;
	 ...
	 * Podemos usar operadores lógicos (`&&`, `||`) para crear condiciones
	 * más complejas.
 ...
 * - `if-else if-else` permite probar varias condiciones en orden y ejecutar
 *   solo la primera verdadera.
