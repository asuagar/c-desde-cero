/*
 * 01_hola_mundo.c - Lección 1: Hello world!
 *
 ...
 *
 * Incluimos `stdio.h`, que significa "cabecera de entrada/salida estándar"
 * del inglés "Standard Input / Output Header".
 ...
 *
 * - `main`: Es el NOMBRE obligatorio de la función de inicio. No se puede
 *   cambiar.
 *
 * - `(void)`: Define los PARÁMETROS o entradas de la función.
 *   `void` es una palabra clave que significa "nada". Por tanto, `(void)` 
 *   indica que esta función no recibe argumentos.
 */
...
int main(void)
{
	 ...
	 * CADENA. Es el dato que pasamos como argumento a la función `printf`.
	 *
	 ...
	 *
	 * Finalmente, el punto y coma `;` al final marca el final de una SENTENCIA
	 * en C. Casi todas las líneas ejecutables en C deben terminar con un punto
	 * y coma.
	 */
	printf("Hello, World!\n");
	 ...
	 * Por convención, `return 0;` indica que el programa terminó correctamente
	 * sin errores.
	 */
	return 0;
}
 ...
 *    - `-o 1_hola_mundo`: Especifica el nombre del archivo de salida
 *      `01_hola_mundo`.
 *    - `01_hola_mundo.c`: Es el archivo fuente que se va a compilar.
 *
 *    gcc -Wall -Wextra -std=c11 -o 01_hola 01_hola_mundo.c
 *
 * 4. Ejecuta el programa generado:
 *    - En Linux/macOS:   ./01_hola_mundo
 *    - En Windows:       01_hola_mundo.exe
 *
