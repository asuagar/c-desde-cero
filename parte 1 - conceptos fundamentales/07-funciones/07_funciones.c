 /**
 * @file 07_funciones.c
 * @brief Parte 1, Lección 7: Funciones
 * @details
 ...
 *    función, su nombre, el tipo de valor que devuelve y los parámetros que acepta.
...
int main(void)
{
    // LLAMADA DE FUNCIÓN: se ejecuta escribiendo su nombre seguido de paréntesis.
    // Esta es una llamada a la función `print_welcome_message`.
...
/**
 * @brief Muestra el nivel del personaje.
...
/**
 * @brief Calcula el daño total combinando fuerza y poder del arma.
