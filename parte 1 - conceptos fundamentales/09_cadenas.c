/*
 * 09_cadenas.c - Parte 1, Lección 9: Cadenas de caracteres (Strings)
 *
 ...
 *
 * EL TERMINADOR NULO:
 * Las cadenas en C siguen una convención: terminan con un carácter
 * especial llamado TERMINADOR NULO `\0`. Este carácter marca el final
 * de la cadena. Por ejemplo, la cadena "Hello" se guarda como
 * ['H', 'e', 'l', 'l', 'o', '\0']. Ocupa 6 caracteres, no 5.
 *
...
#include <stdio.h>
#include <string.h>	/* Biblioteca necesaria para funciones de cadenas. */
...
int main(void)
{
	...
	/*
	 * El especificador de formato `%s` en `printf` sirve para imprimir
	 * cadenas. `printf` recorre el vector de caracteres hasta encontrar
	 * `\0`.
	 */
	...
	/*
	 * Nota: strlen devuelve un tipo especial de entero llamado `size_t`.
	 * Se usa `%zu` para imprimir su valor correctamente y evitar avisos.
	 */
	 ...
	 * `if (str1 == str2)` es incorrecto, ya que compara direcciones
	 * de memoria, no contenido.
	 *
